...
exec_always "setxkbmap -model pc104 -layout us,ara -variant ,, -option grp:alt_ctrl_toggle"
# bindsym $mod+F1 XF86MonBrightnessUp ~/scripts/brightnessctl-root.sh +5%
bindsym $mod+F1 exec sudo brightnessctl set +10%
bindsym $mod+F2 exec sudo brightnessctl set 10%-
# bindsym $mod+F2 XF86MonBrightnessDown exec --no-startup-id brightnessctl set 5%-
